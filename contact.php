...
<body>
  ...
  <section class="w-100 flex justify-content-center mt-11 mb-9">
    <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xs-12">
      ...
      <div class="w-100 mt-5 mb-5 flex">
        <dv class="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-xs-12 containerForm m-auto flex">
           <form class="cont_form flex m-auto" action="./validation_contact.php" method="post" onsubmit="return validation_contect();" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="form-row around">
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-3 mb-3 p-2">
                    <label for="firstName">Nombre(s)</label>
                    <input type="text" id="firstName"  class="form-control validate"  name="firstName" placeholder="" value="" data-length="30" required="">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-3 mb-3 p-2">
                    <label for="lastName">Apellido(s)</label>
                      <input type="text" id="lastName"  class="form-control validate"  name="lastName" placeholder="" value="" data-length="30" required="">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-3 mb-3 p-2">
                    <label for="phone">Teléfono</label>
                      <input type="tel" id="phone" class="form-control validate"  name="phone" placeholder="" value="" data-length="10" required="">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-3 mb-3 p-2">
                    <label for="email">Correo</label>
                      <input type="email" id="email" class="form-control validate"  name="email" placeholder="" value="" data-length="35" required="">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-3 mb-3 p-2 ">
                  <label for="textarea2">Platícanos más, escribe tus comentarios.</label>
                  <textarea class="form-control validate" rows="6" name="messenger" id="messenger" data-length="150" onpaste="contChar();" onkeyup="contChar();" required=""></textarea>
                ...
                <div class="col-xl-12 col-lg-11 col-md-12 col-sm-12 col-xs-12 flex">
                    <button  id="" name="send" class="col-xl-3 col-lg-3 col-md-11 col-sm-11 col-xs-11 btn bg-blue_1" type="submit">Enviar</button>
                </div>
                </div>
           </form>
        </dv>
