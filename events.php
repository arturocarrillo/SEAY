...
<head>
  ...
  <!-- essential -->
  <link rel="canonical" href="http://www.seay.org.mx/events.php">
  <link rel="shortlink" href="http://seay.org.mx/events.php">
  ...
  <title>Eventos</title>
  <!-- Open Graph -->
  <meta property="og:url" content="http://www.seay.org.mx/events.php">
	...
	<section class="w-100 flex justify-content-center mt-11 mb-9">
		<div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xs-12">
			<div class="w-100 mt-5 mb-5 start">
				<h2 class="title text-blue_1 ">Eventos</h2>
			</div>
			<div class="w-80 m-auto mt-5 mb-5 flex-around-stretch">
