    ...
    <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xs-12">
      ...
      <div class="w-100 mt-5 mb-5 flex">
        <dv class="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-xs-12 containerForm m-auto flex">
           <form class="cont_form flex m-auto" action="./validatio-fishing.php" method="post" onsubmit="return validation_contect();" accept-charset="utf-8" enctype="multipart/form-data">
